...
import { getCartPage, getCheckOutPage, getProductDetail, postAddProductToCart, postDeleteProductInCart, postHandleCartToCheckOut } from 'controllers/client/product.controller';
